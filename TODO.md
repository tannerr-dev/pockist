...
- now that local save is automatic
    - create a 'remote save' button that sends a copy of the local data
        ...
        - the database will keep a history of saves
        - flash 'saved to remote disk'
    - create a 'remote sync' button
        - flashes at latest change
        - or download the new copy and show changes
